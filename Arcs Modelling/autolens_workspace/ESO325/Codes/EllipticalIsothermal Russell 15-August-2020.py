...
conf.instance = conf.Config(
    ...
    output_path=f"{workspace_path}/ESO325/Output/EllipticalIsothermal Russell ",
)
...
lens_galaxy.mass.einstein_radius = 2.95
...
phase = al.PhaseImaging(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(redshift=2.1, 
                                  ...
                                  regularization=al.reg.Constant(coefficient=2),
                                 )
                        ),
        settings=settings,
        search = af.Emcee(nwalkers=32, nsteps=500),
    )
