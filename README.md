...
- [CMasher](https://cmasher.readthedocs.io/user/introduction.html)    v.1.6.2
- [dynesty](dynesty.readthedocs.io/)    v.1.1
- [emcee](https://emcee.readthedocs.io/en/stable/)      v.3.0.2
- [Jampy](https://pypi.org/project/jampy/#description)      v.6.1.2
- [Matplotlib](matplotlib.org/) v.3.3.3
- [MgeFit](https://pypi.org/project/mgefit/)     v.5.0.13
- [MPDAF](https://mpdaf.readthedocs.io/en/latest/)      v.3.4
- [Numba](http://numba.pydata.org/)      v.0.50.1
- [Numpy](https://numpy.org/doc/)      v.1.18.5
- [PlotBin](https://pypi.org/project/plotbin/)    v.3.1.3
- [pPXF](https://pypi.org/project/ppxf/)       v.7.2.1
- [PyAutoLens](https://pyautolens.readthedocs.io/en/latest/) v.1.1.4
- [Schwimmbad](https://schwimmbad.readthedocs.io/en/latest/) v.0.3.1
- [SciPy](https://www.scipy.org/)      v.1.5.2
- [VorBin](https://pypi.org/project/vorbin/)     v.3.1.4    
