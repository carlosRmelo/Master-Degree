...
- Finalmente essas massas totais por gaussiana (juntamente com suas dispersões e axial ratio) são passadas ao modelo de lente, onde implementamos os ângulos de deflexão gerados por esse tipo de parametrização.
