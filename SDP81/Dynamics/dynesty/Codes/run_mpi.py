...
boundary = {"ml": [0.5, 15], "qinc": [0.051, 0.468808], "beta1": [-3, 3],
            "beta2": [-3, 3],"beta3": [-3, 3],"beta4": [-3, 3],"beta5": [-3, 3],
            "beta6": [-3, 3],"beta7": [-3, 3],"beta8": [-3, 3],"beta9": [-3, 3],
...
class Model(object):
    ...
    def prior_transform(self, theta):
        ml, qinc, beta1,beta2,beta3,beta4,beta5,beta6,beta7,beta8,beta9, log_mbh, kappa_s, qDM = theta
        parsDic = {"ml":ml, "qinc":qinc, "beta1":beta1, "beta2":beta2,"beta3":beta3,"beta4":beta4,"beta5":beta5,
                           "beta6":beta6,"beta7":beta7,"beta8":beta8,"beta9":beta9,
    ...
    def log_likelihood(self, theta):
        ...
        beta_model  = np.array([beta1,beta2,beta3,beta4,beta5,beta6,beta7,beta8,beta9])
        ml_model    = ml
...
with MPIPool() as pool:
    ...
    p0 = np.array([ml, qinc, beta[0], beta[0], beta[0], beta[0], beta[0], beta[0], beta[0], beta[0], beta[0], np.log10(mbh), kappa_s, qDM])
