...
boundary = {"ml0": [0.5, 15], "delta": [0.1, 2], "lower": [0, 1],  "qinc": [0.051, 0.468808],
             ...
             "mag_shear": [0, 0.1],"phi_shear": [0, 179], "gamma": [0.0, 2.0] }
...
class Model(object):
    ...
    def prior_transform(self, theta):
        ...
        for key in keys: #Loop over the remains parameters
...
with MPIPool() as pool:
    ...
    mgeNFW = dark_mge.NFW(z_l=z_l, z_s=z_s, r_min=0.1, r_max=6.0, nsample=200, quiet=True)
    ...
    print("\n")
    nlive = 800             # number of (initial) live points
