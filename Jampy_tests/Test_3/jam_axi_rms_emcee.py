...
def log_probability(pars):
    ...
    (ml, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, inc, log_mbh) = pars
    
    beta =  np.array([b1, b2, b3, b4, b5, b6, b7, b8, b9, b10])
...
import numpy as np
ml0 = np.array([5])                 #ML
beta0 = np.random.randn(10)         #anisotropy
inc0 = np.array([90])               #inclination
log_mbh0 = np.array([10])           #log mass of black hole

#In order: ML, beta, inclination, log_mbh
p0 = np.append(ml0, beta0)
p0 = np.append(p0, [inc0, log_mbh0])
