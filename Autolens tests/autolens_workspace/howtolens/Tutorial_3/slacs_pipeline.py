...
def make_pipeline(setup, settings):
    ...
    phase1 = al.PhaseImaging(
        ...
        galaxies=dict(lens=al.GalaxyModel(redshift=0.2850, light=al.lp.EllipticalSersic)),
        settings=settings,
    ...
    phase2 = al.PhaseImaging(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(redshift=0.5753, light=al.lp.EllipticalSersic),
        ),
        settings=settings,
    ...
    phase3 = al.PhaseImaging(
        ...
        galaxies=dict(
            ...
            source=al.GalaxyModel(
                redshift=0.5753, light=phase2.result.model.galaxies.source.light
            ),
        ),
        settings=settings,
